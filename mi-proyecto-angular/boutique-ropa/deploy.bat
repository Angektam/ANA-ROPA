...
echo ========================================
echo.
echo Archivos listos en: dist/boutique-ropa/browser
echo.
echo Para hacer deploy:
echo 1. Ve a https://netlify.com
echo 2. Arrastra la carpeta dist/boutique-ropa/browser
echo 3. Obtienes una URL instantanea
echo.
echo O usa: npx netlify deploy --dir=dist/boutique-ropa/browser --prod
echo.
pause
